...
type LayoutRouteId = RouteId | "/" | "/agent-board" | "/agents" | "/apps" | "/auth/login" | "/auth/register" | "/blackboard" | "/brain" | "/comms" | "/costs" | "/crm" | "/data" | "/genomes" | "/health" | "/insights" | "/jobs" | "/lab" | "/leaderboard" | "/learn" | "/linear" | "/memory" | "/notebook" | "/reach" | "/recall" | "/see" | "/see/traces" | "/settings" | "/terminal" | "/workflows" | null
