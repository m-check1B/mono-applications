...
class ChatSession:
    ...
    async def _handle_init_agent(self, content: dict):
        ...
        try:
            ...
            # Extract user_id from websocket query params if available
            user_id = self.websocket.query_params.get("user_id") if self.websocket else None
    ...
    async def _handle_compact_command(self):
        ...
        try:
            ...
            message_lists = self.agent.history.get_messages()
