 ...
 * Voice by Kraliki - AI Call Center Platform
 */
...
/**
 * Test user credentials (matches Voice by Kraliki test credentials)
 */
...
/**
 * Voice by Kraliki specific test data
 */
export const VOICE_TEST_DATA = {
	/**
	 * Test campaigns
	 */
	campaigns: [
...
/**
 * Mock API responses for Voice by Kraliki
 */
export const VOICE_MOCK_RESPONSES = {
	/**
	 * Campaigns list response
	 */
	campaignsList: VOICE_TEST_DATA.campaigns,
