...
import { i as is_primitive, g as get_type, D as DevalueError, a as is_plain_object, e as enumerable_symbols, s as stringify_key, b as stringify_string, c as escaped, d as stringify, p as parse_remote_arg, f as stringify$1, T as TRAILING_SLASH_PARAM, I as INVALIDATED_PARAM } from "./chunks/shared.js";
  ...
  try {
    ...
    if (info.type === "form") {
      ...
      return json(
        ...
        {
          type: "result",
          result: stringify$1(data2, { ...transport, File: file_transport }),
