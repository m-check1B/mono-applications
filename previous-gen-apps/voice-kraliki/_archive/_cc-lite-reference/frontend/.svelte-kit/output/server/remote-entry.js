...
import { h as stringify_remote_arg, j as parse, f as stringify, k as create_remote_cache_key } from "./chunks/shared.js";
      ...
      fn: async (form_data) => {
        ...
        if (validated?.issues !== void 0) {
          ...
          for (let key2 of form_data.keys()) {
            ...
            output.input[key2] = is_array ? values : values[0];
          }
        } else {
          if (validated !== void 0) {
